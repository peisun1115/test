...
function copy {
  ...
  cp ~/workspace/test/HDFS_${OP}_${WT}_1.1.0_C32_${TL} c32_hdfs.dat
  cp ~/workspace/test/HDFS_${OP}_${WT}_1.1.0_C8_${TL} c8_hdfs.dat

  cp ~/workspace/test/RJ_${OP}_${WT}_1.0.1_C32_${TL} c32_rj_1.0.1.dat
  cp ~/workspace/test/RJ_${OP}_${WT}_1.1.0_C32_${TL} c32_rj_1.1.0.dat
}
...
copy LIST_STATUS_Dir ${1} MUST_CACHE
make
cd ../..
